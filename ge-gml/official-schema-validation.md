...
* Validate each document against the latest INSPIRE official schema(s), using strict XML schema validation. 
  ...
  *  Geology: https://inspire.ec.europa.eu/schemas/ge-core/4.0/GeologyCore.xsd
  *  Hydrogeology: https://inspire.ec.europa.eu/schemas/ge_hg/4.0/HydrogeologyCore.xsd
  *  Geophysics: https://inspire.ec.europa.eu/schemas/ge_gp/4.0/GeophysicsCore.xsd
